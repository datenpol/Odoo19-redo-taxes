...
```powershell
py -3 scripts/datenpol_euro_demo.py "<URL>" "<API_KEY>"
```

Read-only diagnosis:

```powershell
py -3 scripts/datenpol_euro_demo.py doctor "<URL>" "<API_KEY>"
py -3 scripts/datenpol_euro_demo.py validate "<URL>" "<API_KEY>"
```

Apply only:

```powershell
py -3 scripts/datenpol_euro_demo.py apply "<URL>" "<API_KEY>"
```
